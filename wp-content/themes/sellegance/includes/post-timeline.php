	...
	<div class="blog_list">
		...
		<div class="entry_info">
			<div class="entry_date">
				<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'sellegance' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><span><?php the_time('j'); ?></span><?php the_time('M'); ?></a>
			</div>    
		</div>
			...
			<div class="entry-meta-foot">
				<ul>
					<?php $tags_list = get_the_tag_list( '', __( ', ', 'sellegance' ) );
						  if ( $tags_list ) :?>
					<li><?php printf( __( 'Tags: %1$s', 'sellegance' ), $tags_list ); ?></li>
