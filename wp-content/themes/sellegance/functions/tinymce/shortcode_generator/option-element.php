...
function tdl_option_element( $name, $attr_option, $type, $shortcode ){
	...
	case 'icons':
		...
		<div class="icon-option">';
			$values = $attr_option['values'];
			foreach( $values as $value ){
		    	$option_element .= '<i class="fa '.$value.'"></i>';
			}
		$option_element .= $desc . '</div>';
	...
	case 'custom':
		...
		if( $name == 'tabs' ){
			...
			<a href="#" class="btn yellow remove-list-item">'.__('Remove Tab', 'sellegance' ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add Tab', 'sellegance' ).'</a>';
		...
		elseif( $name == 'bar_graph' ){
			...
			<a href="#" class="btn yellow remove-list-item">'.__('Remove Bar', 'sellegance' ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add Bar', 'sellegance' ).'</a>';
			...
			$option_element .= '
				<div class="shortcode-dynamic-item" id="options-item" data-name="image-upload">
					...
					<div class="content">
			         ...
			         <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary" rel-id="">' . __('Upload', 'sellegance') . '</a>
			         <a href="javascript:void(0);" class="redux-opts-upload-remove" style="display: none;">' . __('Remove Upload', 'sellegance') . '</a>';
		...
		elseif( $name == 'clients' ){
			...
			<a href="#" class="btn yellow remove-list-item">'.__('Remove Client', 'sellegance' ). '</a> <a href="#" class="btn yellow add-list-item">'.__('Add Client', 'sellegance' ).'</a>';
	...
	default:
	    $option_element .= '
		<div class="label"><label for="shortcode-option-'.$name.'"><strong>'.$attr_option['title'].': </strong></label></div>
		<div class="content"><input class="attr" type="text" data-attrname="'.$name.'" value="'.$attr_option['std'].'" />' . $desc . '</div>';
	    break;
    }
