...
<?php if (get_post_meta( get_the_ID(), 'tdl_page_enable_ioslider', true ) == 1) : ?>
		...
		<script type="text/javascript">
			...
			function slideChange(args) {
				...
				<?php if ($sellegance_opt['main_layout']=='transparent_header') { ?>
	...
	<div class="slidercontainer">
		...
		<div class="iosSlider">
			...
			<div class="slider">
				...
				$thumb = et_resize( $thumb[0], 1600, 700, true, false );
