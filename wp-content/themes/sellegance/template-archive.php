...
<div class="row side_<?php echo $sidebar_pos; ?>">
	...
	<div id="primary" class="col-sm-9 sidebar page-archive">
		...
		<h3 class="archive_title"><?php _e('List of Last 25 Posts:', 'sellegance'); ?></h3>
		...
		<h3 class="archive_title"><?php _e('Posts by Month (Last 3 Months)', 'sellegance'); ?></h3>
		...
		<?php for( $pm = 0; $pm < 3; $pm++ ){
			...
			<h3 class="archive_title"><?php _e('Posts by Subject (Categories)', 'sellegance'); ?></h3>
