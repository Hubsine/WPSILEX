	...
	class WP_Widget_Custom_Brands extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
					...
					'Sellegance / Brands', // Name  
					array('description' => __('Brands list','sellegance'))
			);
		}
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Widget Title:', 'sellegance') ?></label><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Show Brands at most:', 'sellegance') ?></label><BR/>
			<input type="text" id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" value="<?php echo $number ?>" class="widefat" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('show_logo'); ?>"><?php _e('Show Logo:', 'sellegance') ?></label><br/>
			<select id="<?php echo $this->get_field_id('show_logo'); ?>" name="<?php echo $this->get_field_name('show_logo'); ?>" class="widefat" >
