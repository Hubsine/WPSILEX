...
if ( $products->have_posts() ) : ?>
    ...
    <div class="four_side">
        ...
        <div class="related_products prod_slider items_slider_id_<?php echo $sliderrandomid ?>" data-columns="<?php echo $woocommerce_loop['columns']; ?>">
            
            <div class="items_sliders_header">
                <div class="items_sliders_title">
                    <div class="featured_section_title"><span><?php _e('Related Products', 'sellegance'); ?></span></div>
