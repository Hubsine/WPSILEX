...
function tdl_tiny() {
	...
	if ( get_user_option('rich_editing') == 'true' ) {
		...
		add_filter( 'mce_buttons', 'register_tdl_tinymce_button' );
	}
 
}

add_action('init', 'tdl_tiny');


function add_js_plugin( $plugin_array ) {
   $plugin_array['tdl_buttons'] = get_template_directory_uri() . '/functions/tinymce/tdl.tinymce.js';
   return $plugin_array;
}
...
# Create Button
#-----------------------------------------------------------------
function register_tdl_tinymce_button( $buttons ) {
