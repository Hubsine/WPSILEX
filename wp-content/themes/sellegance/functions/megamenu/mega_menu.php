...
class TDL_MegaMenu_Nav_Menu extends Walker_Nav_Menu {
	...
	function start_el(&$output, $object, $depth = 0, $args = array(), $id = 0) {
		...
		if ( isset( $object->post_status ) && 'draft' == $object->post_status ) {
			...
			$title = sprintf( __('%s (Pending)','sellegance'), $object->title );
		}
			...
			<dl class="menu-item-bar">
				<dt class="menu-item-handle">
					...
					<span class="item-controls">
						...
						<span class="item-type item-type-tdl-column"><?php _e('Column','sellegance'); ?></span>
						<span class="item-type item-type-hmenu"><?php _e('(Mega Menu)','sellegance'); ?></span>
						<span class="item-type item-type-tdl-widget"><?php _e('Widget','sellegance'); ?></span>

						
						<a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php _e('Edit Menu Item','sellegance'); ?>" href="<?php
						...
						?>"><?php _e( 'Edit Menu Item' ,'sellegance'); ?>
						</a>
					</span>
				</dt>
			</dl>
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="description description-thin">
					<label for="edit-menu-item-title-<?php echo $item_id; ?>">
						<?php _e( 'Navigation Label','sellegance' ); ?><br />
				...
				<p class="description description-thin">
					<label for="edit-menu-item-attr-title-<?php echo $item_id; ?>">
						<?php _e( 'Title Attribute','sellegance' ); ?><br />
				...
				<p class="field-link-target description description-thin">
					<label for="edit-menu-item-target-<?php echo $item_id; ?>">
						<?php _e( 'Link Target','sellegance' ); ?><br />
						<select id="edit-menu-item-target-<?php echo $item_id; ?>" class="widefat edit-menu-item-target" name="menu-item-target[<?php echo $item_id; ?>]">
							<option value="" <?php selected( $object->target, ''); ?>><?php _e('Same window or tab','sellegance'); ?></option>
							<option value="_blank" <?php selected( $object->target, '_blank'); ?>><?php _e('New window or tab','sellegance'); ?></option>
						</select>
					</label>
				</p>
				<p class="field-css-classes description description-thin">
					<label for="edit-menu-item-classes-<?php echo $item_id; ?>">
						<?php _e( 'CSS Classes (optional)','sellegance' ); ?><br />
				...
				<p class="field-xfn description description-thin">
					<label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
						<?php _e( 'Link Relationship (XFN)','sellegance' ); ?><br />
				...
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo $item_id; ?>">
						<?php _e( 'Description','sellegance' ); ?><br />
						...
						<span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.','sellegance'); ?></span>
					</label>
				</p>
				...
				<div class="menu-item-actions description-wide submitbox">
					...
					<p class="tdl_megamenu_row_box clearfix">
						<label for="menu-item-newrow-<?php echo $item_id; ?>"><input type="checkbox" id="menu-item-newrow-<?php echo $item_id; ?>"  name="menu-item-newrow-<?php echo $item_id; ?>" <?php  echo $newrow; ?> /> New row </label>&nbsp;&nbsp;&nbsp;
						
						<label for="menu-item-fullwidth-<?php echo $item_id; ?>"><input type="checkbox" id="menu-item-fullwidth-<?php echo $item_id; ?>"  name="menu-item-fullwidth-<?php echo $item_id; ?>" <?php  echo $fullwidth; ?> /> Full-width row </label>&nbsp;&nbsp;&nbsp;
						
						<label for="menu-item-enable-textbox-<?php echo $item_id; ?>"><input type="checkbox" id="menu-item-enable-textbox-<?php echo $item_id; ?>"  name="menu-item-enable-textbox-<?php echo $item_id; ?>" <?php  echo $enable_textbox; ?> class="enable_textbox" /> Enable HTML box <textarea name="menu-item-textbox-<?php echo $item_id; ?>" id="menu-item-textbox-<?php echo $item_id; ?>" class="textbox <?php if($enable_textbox=="") echo "hide"; ?>" > <?php echo $textbox; ?></textarea></label>
					...
					<?php if( 'custom' != $object->type ) : ?>
						<p class="link-to-original">
							<?php printf( __('Original:','sellegance').' %s', '<a href="' . esc_attr( $object->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
						</p>
					<?php endif; ?>
					<?php
						$url = wp_nonce_url(
					...
					<a class="item-delete submitdelete deletion" id="delete-<?php echo $item_id; ?>" href="<?php echo esc_url($url); ?>"><?php _e('Remove','sellegance'); ?>
					</a> 
					...
					<a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php	echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time() ), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
							?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel','sellegance'); ?>
					</a>
				</div>
...
function hmenu_scripts()
{
	...
	{
		wp_enqueue_script( 'tdl_mega_menu' , get_template_directory_uri() . '/functions/megamenu/mega_menu.js',array('jquery', 'jquery-ui-sortable'), false, true ); 
		wp_enqueue_style('tdl-admin-style', get_template_directory_uri() . '/functions/megamenu/mega_menu_style.css');
	}
}
