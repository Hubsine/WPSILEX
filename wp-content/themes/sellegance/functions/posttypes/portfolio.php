...
$options = array(
  'single' => __('Portfolio', 'sellegance' ),
  'plural' => __('Portfolio', 'sellegance' ),
  'singlealt' => __('Portfolio Item', 'sellegance' ),
  'pluralalt' => __(' Portfolio Items', 'sellegance' ),
  'type' => 'portfolio',
...
function create_portfolio_taxonomies() {
  ...
  $labels = array(
	'name' => __( 'Groups', 'sellegance' ),
	'singular_name' => __( 'Group', 'sellegance' ),
	'search_items' =>  __( 'Search Groups', 'sellegance' ),
	'popular_items' => __( 'Popular Groups', 'sellegance' ),
	'all_items' => __( 'All Groups', 'sellegance' ),
	'parent_item' => null,
	'parent_item_colon' => null,
	'edit_item' => __( 'Edit Group', 'sellegance' ), 
	'update_item' => __( 'Update Group', 'sellegance' ),
	'add_new_item' => __( 'Add New Group', 'sellegance' ),
	'new_item_name' => __( 'New Group Name', 'sellegance' ),
	'separate_items_with_commas' => null,
	'add_or_remove_items' => null,
	'choose_from_most_used' => null,
	'menu_name' => __( 'Groups', 'sellegance' ),
  ); 
...
function tdl_columns_head_portfolio($defaults) {
	$defaults['portfolio_thumb'] = __( 'Thumbnail', 'sellegance' );
	$defaults['portfolio_type'] = __('Item Type', 'sellegance' );
	$defaults['portfolio_group'] = __('Group', 'sellegance' );
	return $defaults;
}
...
function tdl_enable_portfolio_sort() {
	add_submenu_page('edit.php?post_type=portfolio', __('Sort Portfolio Items', 'sellegance' ), __('Sort Portfolio', 'sellegance' ), 'edit_posts', 'sort_portfolio_items', 'tdl_sort_portfolio');
}
...
?>
	<div class="wrap">
	<h2><?php echo __('Sort Portfolio Items', 'sellegance' );?> <img src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
